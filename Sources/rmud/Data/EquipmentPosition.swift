...
enum EquipmentPosition: Int8, CaseIterable {
    ...
    var alreadyWearing: String {
        ...
        case .fingerLeft: return "У Вас уже что-то надето на пальцах обеих рук."
        case .neck: return "Вы больше ничего не можете надеть на шею."
        case .neckAbout: return "Вы больше ничего не можете надеть вокруг шеи."
        case .body: return "У Вас уже что-то надето на теле."
        case .head: return "У Вас уже что-то надето на голове."
        case .face: return "У Вас уже что-то надето на лице."
        case .legs: return "У Вас уже что-то надето на ногах."
        case .feet: return "Вы уже обуты."
        case .hands: return "У Вас уже что-то надето на кистях рук."
        case .arms: return "У Вас уже что-то надето на руках."
        case .shield: return "Вы уже используете щит."
        case .about: return "У Вас уже что-то надето вокруг тела."
        case .back: return "Вы больше ничего не можете надеть за спину."
        case .waist: return "У Вас уже что-то надето вокруг талии."
        // FIXME: it's bad to assume here that both wrists are in use
        case .wristRight: return "У Вас уже что-то надето на запястьях обеих рук."
        case .wristLeft: return "У Вас уже что-то надето на запястьях обеих рук."
        case .ears: return "У Вас уже что-то надето в ушах."
        case .wield: return "Вы уже вооружены оружием."
        case .hold: return "Вторая рука у Вас уже занята."
        case .twoHand: return "Вы уже держите оружие в обеих руках."
        }
    }
