...
enum EquipmentPosition: Int8, CaseIterable {
    ...
    var alreadyWearing: String {
        switch self {
        case .light: return "@1в нельзя взять в руку, поскольку Вы уже держите в руке источник света."
        case .fingerRight, .fingerLeft: return "@1в нельзя надеть, поскольку у Вас уже что-то надето на пальцах обеих рук."
        case .neck: return "@1в нельзя надеть, поскольку у Вас уже что-то надето на шее."
        case .neckAbout: return "@1в нельзя надеть, поскольку у Вас уже что-то надето вокруг шеи."
        case .body: return "@1в нельзя надеть, поскольку у Вас уже что-то надето на теле."
        case .head: return "@1в нельзя надеть, поскольку у Вас уже что-то надето на голове."
        case .face: return "@1в нельзя надеть, поскольку у Вас уже что-то надето на лице."
        case .legs: return "@1в нельзя надеть, поскольку у Вас уже что-то надето на ногах."
        case .feet: return "@1в нельзя надеть, поскольку Вы уже обуты."
        case .hands: return "@1в нельзя надеть, поскольку У Вас уже что-то надето на кистях рук."
        case .arms: return "@1в нельзя надеть, поскольку У Вас уже что-то надето на руках."
        case .shield: return "@1в нельзя пристегнуть на руку, поскольку Вы уже используете щит."
        case .about: return "@1в нельзя надеть, поскольку у Вас уже что-то надето вокруг тела."
        case .back: return "@1в нельзя надеть, поскольку у Вас уже что-то надето за спиной."
        case .waist: return "@1в нельзя надеть, поскольку у Вас уже что-то надето вокруг талии."
        case .wristRight, .wristLeft: return "@1в нельзя надеть, поскольку у Вас уже что-то надето на запястьях обеих рук."
        case .ears: return "@1в нельзя надеть, поскольку У Вас уже что-то надето в ушах."
        case .wield: return "@1т нельзя вооружиться, поскольку Вы уже вооружены оружием."
        case .hold: return "@1в нельзя взять во вторую руку, поскольку она у Вас уже занята."
        case .twoHand: return "@1т нельзя вооружиться, поскольку Вы уже держите оружие в обеих руках."
        }
    }
